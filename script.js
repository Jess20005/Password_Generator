...
function generatePassword() {
  ...
  var upperCaseChars = "ABCDEFGHIJKLMNOPQRSTUZWXYZ".split("");
  ...
  if (hasLowerCase === true ) {
    combinedChars = combinedChars.concat(lowerCaseChars);
  }
  ...
  for (var i =0; i<=passwordLength; i++) {
    randomPassword.push(combinedChars[Math.floor(Math.random() * combinedChars.length)]);
  }
